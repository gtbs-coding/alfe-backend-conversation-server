...
Fakturanummer: ${req.body.docNumber}
${req.body.relatedDocuments}

Att Betala: ${req.body.toPay}
Förfallodatum: ${req.body.dueDate}
...
`
	...
	<div style="color: beige; background-color: #414445; padding: 20px;">
		<p>
			...
			<br>
			Fakturanummer: ${req.body.docNumber} <br>
		...
		<p style="color: #323232; background-color: #dedede; width: 400px; padding: 10px;">
			...
			<span style="color: red;">Förfallodatum: </span>${req.body.dueDate} <br>
	...
	`
		...
		const mail: Mail = {
			...
			subject: `${req.body.subject} ${req.body.docNumber}, Förfallodatum: ${req.body.dueDate}, Att betala: ${req.body.toPay}`,
			priority: 'high',
			text: contentText,
			html: contentHtml,
			attachments: [
