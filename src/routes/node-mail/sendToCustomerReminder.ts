...
const sendToCustomerReminderRouter = express.Router()
...
sendToCustomerReminderRouter.post(
	'/',
...
Påminnelsenummer: ${req.body.reminderNumber}
Relaterade Faktura: ${req.body.invoiceNumber}
${req.body.relatedDocuments}

Att Betala: ${req.body.toPay}
Förfallodatum: ${req.body.reminderDueDate}
...
`
	...
	<div style="color: beige; background-color: #414445; padding: 20px;">
		<p>
			...
			<br>
			Påminnelsenummer: ${req.body.reminderNumber} <br>
			Relaterade Faktura: ${req.body.invoiceNumber} <br>
		...
		<p style="color: #323232; background-color: #dedede; width: 400px; padding: 10px;">
			...
			<span style="color: red;">Förfallodatum: </span>${req.body.reminderDueDate} <br>
	...
	`
		...
		// console.log('req.files', req.files.pdfFileStream.data)
...
export default sendToCustomerReminderRouter
